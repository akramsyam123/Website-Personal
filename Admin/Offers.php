...
<div id="wrapper">
  ...
  <div id="content">
    ...
    <label for="search">Search Offer:</label>
    <input type="text" name="search" id="search" placeholder="Enter Offer Name">
...
// SQL Query untuk data Offer
$sql = "SELECT * FROM Offer_Master";
if (!empty($search)) {
    $sql .= " WHERE Offer LIKE '%$search%'";
}
